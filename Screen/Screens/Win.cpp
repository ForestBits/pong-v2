...
Win::Win(ScreenConstructionParameters parameters) : backButton(parameters.font, parameters.clickSound), playButton(parameters.font, parameters.clickSound)
{
...
void Win::update(ScreenUpdateParameters parameters)
{
...
void Win::draw(sf::RenderTarget & target, const TransitionInfo & transition)
{
